...
<div class="ing_bnr_Wrap">
    ...
    <div class="bnrtxtwrap">
        <h3 class="wow fadeInDown">내정보 찾기</h3>
        <div class="bnrline wow fadeInDown" data-wow-delay="0.1s"></div>
        <!--        <p class="wow fadeInDown" data-wow-delay="0.2s">동양네트워크의 회원가입</p>-->
    </div>
</div>
<div id="find_info" class="new_win<?php if($config['cf_cert_use'] != 0 && $config['cf_cert_find'] != 0) { ?> cert<?php } ?>" style="padding: 5% 10%;">
    <div class="new_win_con">
        <form name="fpasswordlost" style="padding: 4% 5%;" action="<?php echo $action_url ?>" onsubmit="return fpasswordlost_submit(this);" method="post" autocomplete="off">
        <h3>이메일로 찾기</h3>
        <fieldset id="info_fs">
            <p>
