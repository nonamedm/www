...
<div class="ing_bnr_Wrap">
    ...
    <div class="bnrtxtwrap">
        <h3 class="wow fadeInDown">login</h3>
        <div class="bnrline wow fadeInDown" data-wow-delay="0.1s"></div>
        <p class="wow fadeInDown" data-wow-delay="0.2s">동양네트워크의 연혁에 대해 말씀 드립니다.</p>
    </div>
</div>
<!-- 로그인 시작 { -->
<div id="mb_login" class="mbskin" style="margin-top:100px;margin-bottom:100px;">
