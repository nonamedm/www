...
<div id="bo_gall">
    ...
    <?php if ($is_checkbox) { ?>
    <div id="gall_allchk">
        <label for="chkall"><span class="sound_only">현재 페이지 게시물</span>전체</label>
        ...
        <li class="gall_li <?php if ($wr_id == $list[$i]['wr_id']) { ?>gall_now<?php } ?>">
            ...
            <div class="gall_con">
                <div class="gall_img">
	                ...
	                <?php if($list[$i]['ca_name']) { ?><a href="<?php echo $list[$i]['ca_name_href'] ?>" class="bo_cate_link"><?php echo $list[$i]['ca_name'] ?></a><?php } ?>
                </div>
                <div id="gall_ct">
	                ...
	                <div class="gall_info">
                        ...
                        <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span class="cnt_cmt gi_bg"><i class="fa fa-commenting-o"></i> <?php echo $list[$i]['wr_comment']; ?></span><span class="sound_only">개</span><?php } ?>
    ...
    <div class="bo_fx">
        <ul class="btn_bo_adm">
            <?php if ($is_checkbox) { ?>
            <li><button type="submit" name="btn_submit" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_admin2">선택삭제</li>
            <li><button type="submit" name="btn_submit" value="선택복사" onclick="document.pressed=this.value" class="btn btn_admin2">선택복사</li>
            <li><button type="submit" name="btn_submit" value="선택이동" onclick="document.pressed=this.value" class="btn btn_admin2">선택이동</li>
            <?php } ?>
