...
$g5['title'] = '메인베스트 카테고리설정';
include_once('./head.php');
?>

<form name="fcategory" id="fcategory" method="post" action="./mainbestcategoryupdate.php">
...
<div class="con_right add_cate add_cate1">
    <div class="con_wr">
        <h2>메인베스트카테고리</h2>
        <p>최대 6개 등록가능합니다</p>
        <ul>
        <?php
        $save_file = G5_DATA_PATH.'/cache/theme/buzinga/mainbestcategory.php';
        ...
        ?>
            <li>
                <div class="add_cate_info">
                    <input type="hidden" name="ca_id[]" value="<?php echo $val; ?>">
                    <input type="checkbox" name="ca_chk[]" value="1">
