...
@mkdir(G5_DATA_PATH."/cache/theme/buzinga", G5_DIR_PERMISSION);
@chmod(G5_DATA_PATH."/cache/theme/buzinga", G5_DIR_PERMISSION);

$save_file = G5_DATA_PATH.'/cache/theme/buzinga/maincategory.php';
$maincategory = array();
$setting = array();
$ca_ids = array();
