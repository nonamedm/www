...
$theme_config = array(
    ...
    'de_type1_img_width'            => 230,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 230,     // PC 히트상품 이미지 높이
    ...
    'de_type2_img_width'            => 230,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 230,     // PC 추천상품 이미지 높이
    ...
    'de_type3_img_width'            => 230,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 230,     // PC 최신상품 이미지 높이
    'de_type4_list_use'             => 1,       // PC 인기상품 출력
    'de_type4_list_skin'            => 'main.50.skin.php', // PC 인기상품 출력스킨
    'de_type4_list_mod'             => 1,       // PC 인기상품 출력 1줄당 이미지 수
    'de_type4_list_row'             => 5,       // PC 인기상품 출력 출력 줄 수
    'de_type4_img_width'            => 230,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 230,     // PC 인기상품 이미지 높이
    'de_type5_list_use'             => 1,       // PC 할인상품 출력
    'de_type5_list_skin'            => 'main.10.skin.php', // PC 할인상품 출력스킨
    'de_type5_list_mod'             => 4,       // PC 할인상품 출력 1줄당 이미지 수
    'de_type5_list_row'             => 2,       // PC 할인상품 출력 출력 줄 수
    'de_type5_img_width'            => 230,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 230,     // PC 할인상품 이미지 높이
    'de_mobile_type1_list_use'      => 1,       // 모바일 히트상품 출력
    'de_mobile_type1_list_skin'     => 'main.10.skin.php', // 모바일 히트상품 출력스킨
    'de_mobile_type1_list_mod'      => 4,       // 모바일 히트상품 출력 1줄당 이미지 수
    'de_mobile_type1_list_row'      => 1,       // 모바일 히트상품 출력 출력 줄 수
    ...
    'de_mobile_type2_list_skin'     => 'main.20.skin.php', // 모바일 추천상품 출력스킨
    'de_mobile_type2_list_mod'      => 4,       // 모바일 추천상품 출력 1줄당 이미지 수
    ...
    'de_mobile_type3_list_mod'      => 4,       // 모바일 최신상품 출력 1줄당 이미지 수
    'de_mobile_type3_list_row'      => 1,       // 모바일 최신상품 출력 출력 줄 수
    ...
    'de_mobile_type4_list_skin'     => 'main.10.skin.php', // 모바일 인기상품 출력스킨
    'de_mobile_type4_list_mod'      => 4,       // 모바일 인기상품 출력 1줄당 이미지 수
    'de_mobile_type4_list_row'      => 1,       // 모바일 인기상품 출력 출력 줄 수
    ...
    'de_search_list_row'            => 3,       // 검색상품 출력 줄 수
    'de_search_img_width'           => 300,     // 검색상품 이미지 폭
    'de_search_img_height'          => 300,     // 검색상품 이미지 높이
    'de_mobile_search_list_skin'    => 'list.10.skin.php',  // 모바일 검색상품 출력 스킨
    'de_mobile_search_list_mod'     => 4,       // 모바일 검색상품 1줄당 이미지 수
    'de_mobile_search_list_row'     => 3,       // 모바일 검색상품 출력 줄 수
    'de_mobile_search_img_width'    => 300,     // 모바일 관련상품 이미지 폭
    'de_mobile_search_img_height'   => 300,     // 모바일 관련상품 이미지 높이
    'de_mimg_width'                 => 300,     // 상품상세 이미지 Width
    'de_mimg_height'                => 300,     // 상품상세 이미지 Height
    'ca_skin'                       => 'list.10.skin.php',  // 분류 리스트 스킨
    'ca_img_width'                  => 300,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 300,     // 분류 리스트 이미지 높이
    ...
    'ca_mobile_list_mod'            => 4,       // 모바일 분류 리스트 1줄당 이미지 수
    'ca_mobile_list_row'            => 5,       // 모바일 분류 리스트 이미지 줄 수
    'ev_skin'                       => 'list.10.skin.php',  // 이벤트 출력 스킨
    'ev_img_width'                  => 230,     // 이벤트 리스트 이미지 폭
    'ev_img_height'                 => 230,     // 이벤트 리스트 이미지 높이
    ...
    'ev_mobile_list_mod'            => 1,       // 모바일 이벤트 1줄당 이미지 수
    'ev_mobile_list_row'            => 1,       // 모바일 이벤트 이미지 줄 수
    'ca_mobile_list_best_mod'       => 1,       // 모바일 상품리스트 베스트상품 1줄당 이미지 수
    'ca_mobile_list_best_row'       => 1,       // 모바일 상품리스트 베스트상품 이미지 줄 수
);
