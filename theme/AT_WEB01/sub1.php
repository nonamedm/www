    ...
    <div class="inner">
       <div class="con3wrap">
        ...
        <section class="con3_sect1">
            <article><img class="wow bounceInUp" src="<?php echo G5_THEME_IMG_URL?>/sub/year18.png" alt=""></article>
            <article><img class="wow bounceInUp" src="<?php echo G5_THEME_IMG_URL?>/sub/year17.png" alt=""></article>
            <article><img class="wow bounceInUp" src="<?php echo G5_THEME_IMG_URL?>/sub/year16.png" alt=""></article>
            <article><img class="wow bounceInUp" data-wow-delay=".1s" src="<?php echo G5_THEME_IMG_URL?>/sub/year15.png" alt=""></article>
            <article><img class="wow bounceInUp" data-wow-delay=".1s" src="<?php echo G5_THEME_IMG_URL?>/sub/year14.png" alt=""></article>
            <article><img class="wow bounceInUp" data-wow-delay=".1s" src="<?php echo G5_THEME_IMG_URL?>/sub/year13.png" alt=""></article>
        </section>
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year18.png" alt=""></div>
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year17.png" alt=""></div>
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year16.png" alt=""></div>
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year15.png" alt=""></div>
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year14.png" alt=""></div>
                <div class="swiper-slide"><img src="<?php echo G5_THEME_IMG_URL?>/sub/year13.png" alt=""></div>
            </div>
