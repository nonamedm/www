...
<!-- <div class="brd-bn">
    <div class="brd-bn-wrap">
        <h2 class="brd-bn-tit">고객센터</h2>
        <span class="brd-bn-desc">월~금10:00-18:00/점심시간12:00-13:00/토,일,공휴일휴무</span>
    </div>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_com">
           <li><a href="<?php echo $list_href ?>" class="btn_b01 btn"> 목록</a></li>
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn">문의하기</a></li><?php } ?>
        </ul>
