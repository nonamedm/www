...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_contact">
            <div>
                <!--<img src="<?php /*echo G5_THEME_IMG_URL */?>/tel.png" style="width: 35px; height: 35px; float: left; margin: 6px; margin-left: 95px;">-->
        ...
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : (주)다인테크</li>
                <li class="ft_company2">대표 : 이승준</li>
                <li class="ft_company3">주소 : 대전광역시 유성구 테크노1로 75, 한밭대학교 창업보육센터 213호</li>
                <li class="ft_company4">메일 : yisj@daintech9.co.kr</li>
        ...
        <div id="ft_copy">
            Copyright &copy; <b>Whipping Tree</b> <span>All rights reserved.</span>
        </div>
    </div>
