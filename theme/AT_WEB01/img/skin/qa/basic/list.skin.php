...
<script>
      $(function(){
      if(location.href.indexOf('http://at0013.iwinv.net/bbs/board.php?bo_table=qa') > -1){ // location.href 로 현재 페이지 주소를 가져옵니다. 
    document.getElementById('thead').style.display = 'none'; //매칭된 페이지에 한해 특정 요소에 스타일을 부여합니다. 
}
    });
</script>
<?php } ?>
