...
<div id="bo_list" style="width:<?php echo $width; ?>">
    <div class="inner">
        ...
        <!-- 게시판 카테고리 시작 { -->
        <?php if ($is_category) { ?>
        <nav id="bo_cate" class="wow fadeInUp">
        ...
        <div id="bo_list_total" class="wow fadeInUp" data-wow-delay="0.3s">
            <span>전체 <?php echo number_format($total_count) ?></span>
            <!--     <?php echo $page ?> -->

            <!--     <select name="sfl" id="sfl" class="sfls">
            <option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>최신</option>
                ...
                if ($is_category && $list[$i]['ca_name']) {
                 ?>
                    ...
                    ?>
                            ...
                            <td class="td_name sv_use notice_td_name" style="text-align:center"><?php echo $list[$i]['name'] ?></td>
   ...
   <div class="bo_fx">
        ...
        <ul class="btn_bo_user">
            ...
            <?php } ?>
            <?php if ($list_href) { ?><li><a href="<?php echo $list_href ?>" class="btn_b01 btn notice_btn01"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li><?php } ?>
            <?php if ($is_admin) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn notice_btn02">글쓰기</a></li><?php } ?>
        </ul>
        <?php } ?>
    </div>
            <?php } ?>
...
<div class="inner clearfix">
    <fieldset id="bo_sch" class="wow fadeInUp">
