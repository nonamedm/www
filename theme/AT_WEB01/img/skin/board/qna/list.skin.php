    ...
    <div id="bo_list" class="faq_bo_list">
        ...
        <div id="bo_btn_top" class="faq_bo_btn_top wow fadeInUp">
            ...
            <ul class="btn_bo_user faq_btn_bo_user">
                ...
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn faq_btn"> 문의하기</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
        <!-- } 게시판 페이지 정보 및 버튼 끝 -->
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <th scope="col" class="th_date"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>작성일 </a></th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <td class="td_subject faq_td_subject" style="padding-left:<?php echo $list[$i]['reply'] ? (strlen($list[$i]['wr_reply'])*10) : '0'; ?>px">
                    <?php
        ...
        <div class="bo_fx faq_bo_fx">
            ...
            <ul class="btn_bo_user">
                ...
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn faq_submit"> 문의하기</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
        <?php } ?>
...
<div class="inner">
    <!-- 게시판 검색 시작 { -->
    <fieldset id="bo_sch" class="faq_bo_sch wow fadeInUp">
        ...
        <form name="fsearch" method="get">
            ...
            <button type="submit" value="검색" class="sch_btn"><i class="fa fa-search" aria-hidden="true"></i>검색<span class="sound_only">검색</span></button>
        </form>
    </fieldset>
    <!-- } 게시판 검색 끝 -->
