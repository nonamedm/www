...
<div class="lat">
    <div class="lat_title_area">
        ...
        <a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=<?php echo $bo_table ?>" class="lt_more"><span class="sound_only"><?php echo $bo_subject ?></span><span class="sound_only"> 더보기</span>+</a>
    </div>
    <ul>
