...
<div id="ft">
    <div id="ft_wr">
       <div id="ft_sns">
        ...
        <div id="ft_company">
            <ul>
                <li class="ft_company1">상호 : 동양네트워크</li>
                <li class="ft_company2">대표 : 홍길동</li>
                <li class="ft_company3">주소 : 서울 영등포구 문래동3가 55-20번지 에이스하이테크시티 2동 1607호</li>
                <li class="ft_company4">메일 : test@naver.com</li>
                <li class="ft_company5">사업자등록번호 : 123-45-67890</li>
