...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_btn_top">
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn btn_write"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
    ...
    <!-- 게시판 검색 시작 { -->
    <div class="bo_sch_wrap" style="display:block;">
