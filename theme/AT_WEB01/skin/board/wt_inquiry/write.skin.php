...
<div class="mdlTxt">
    <h2 class="wow flipInX" data-wow-duration="2s">시스템문의 및 견적 문의 </h2>
...
<article class="inner">
    <section id="bo_w" class="respon_w ct1">
        ...
        <article class="res_w">
			...
			<!--<h2 class="wr_title">
                <span class="wr_v_title">시스템 견적 및 문의</span>
            </h2>-->
			<div class="tb_outline">
				<div class="div_tb">
                    ...
                    <div class="div_tb_tr">
                        <div class="div_th">
                            <label for="wr_4">구분<strong class="sound_only">필수</strong><span class="red">*</span></label>
                        </div>
                    ...
                    <div class="div_tb_tr">
						<div class="div_th">
							<label for="wr_1">회사명<strong class="sound_only">필수</strong></label>
						</div>
						<div class="div_td">
							<input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="" style="width:140px" >
						</div>
					</div>
                    ...
                    <?php if ($is_email != "") { ?>
                        <div class="div_tb_tr">
                            ...
                            <div class="div_td">
                                ...
                                <input type="hidden" name="wr_email" value="<?=$write[wr_email]?>" />
                                <?$wr_email_=explode("@",$write[wr_email]);?>
                                    <li class="" style="width:140px; float: left; margin-right: 5px;"><input type="text" id="wr_email1" name="wr_email1" class="" value="<?=$wr_email_[0]?>" required/></li>
                                    <li style="width:auto; float: left; margin-right: 5px;">@</li>
                                    <li class="" style="width:140px; float: left; margin-right: 5px;"><input type="text" id="wr_email2" name="wr_email2" class="" value="<?=$wr_email_[1]?>" required /></li>
                                    <li class="" style="width:140px; float: left; margin-right: 5px;">
                    ...
                    <?php if ($is_password) { ?>
                        <div class="div_tb_tr">
                            ...
                            <div class="div_td">
                                <div id="autosave_wrapper">
                                    <input type="password" name="wr_password" value="<?php echo $wr_password ?>" id="wr_password"  class="" size="" maxlength="" required placeholder="비밀번호를 입력해 주세요"/>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
					...
					<?php for ($i=0; $is_file && $i<$file_count; $i++) { ?>
						<div class="div_tb_tr">
							...
							<div class="div_td">
                                <label for="bf_file_<?php echo $i+1 ?>" class="lb_icon" style="float: left; margin-right: 10px;"><i class="fa fa-folder-open" aria-hidden="true"></i><span class="sound_only"> 파일 #<?php echo $i+1 ?></span></label>
					...
					<?php if ($bo_table!='s3_1') { //자동등록방지  ?>
						<div class="div_tb_tr">
							<div class="div_th">자동등록방지<span class="red">*</span></div>
        ...
        <div class="btn_confirm write_div">
            <a href="<?php echo get_pretty_url($bo_table); ?>" class="btn_b01 btn">취소</a><!--btn_cancel-->
            <button type="submit" id="btn_submit" accesskey="s" class="btn_b01 btn">문의하기</button><!--btn_submit-->
        </div>
        </form>
        ...
        {
            if (f.wr_3.value != 'Y') {
                alert("개인정보취급방침에 동의하셔야 작성할 수 있습니다.");
                //f.wr_3.focus();
                return false;
            }
