...
<article id="bo_v">
   <div class="inner">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <span class="">작성자 : </span><strong class="bo_v_writer"><?php echo $view['name'] ?></strong>
    ...
    <section id="bo_v_info">
        <span class="">회사명 : </span><strong class="bo_v_writer"><?php echo $view['wr_1'] ?></strong>
        <span class="">연락처 : </span><strong class="bo_v_writer"><?php echo $view['wr_2'] ?></strong>
        <span class="">이메일 : </span><strong class="bo_v_writer"><?php echo $view['wr_email'] ?></strong>
    </section>
    <section id="bo_v_atc">
    ...
    <div id="bo_v_top">
        ...
        <div class="bo_v_left">
            <?php if ($update_href) { ?><a href="<?php echo $update_href ?>" class="btn_b01 btn btn_change"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a><?php } ?>
            <?php if ($delete_href) { ?><a href="<?php echo $delete_href ?>" class="btn_b01 btn btn_change" onclick="del(this.href); return false;"><i class="fa fa-trash-o" aria-hidden="true"></i> 삭제</a><?php } ?>
        ...
        <div class="bo_v_com">
           <a href="<?php echo $list_href ?>" class="btn_b01 btn btn_list"><i class="fa fa-list" aria-hidden="true"></i> 목록</a>
