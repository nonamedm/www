            ...
            <div class="inner">
                ...
                <div class="tbl_head01 tbl_wrap">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="col5"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 </a></th>
                            <?php if ($is_good) { ?><th scope="col"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 </a></th><?php } ?>
                            <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 </a></th><?php } ?>
                            <th scope="col" class="col6"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  </a></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php
                        ...
                        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?> <?php echo $lt_class ?>">
                            ...
                            <td class="td_num2">
                                ...
                                <?php } else {?>
                                    ...
                                    <p>
                                     <span class="icon"><i class="xi-check-circle" aria-hidden="true"></i></span>
                                     <span class="text">답변완료</span>
                                    </p>
                                    <?php } else {?>
                                    <p>
                                        <span  class="icon"><i class="xi-message" aria-hidden="true"></i></span>
                                        <span class="text">접수완료</span>
                                    </p>
                                    <?php } ?>
                                <?php } ?>
                            </td>
