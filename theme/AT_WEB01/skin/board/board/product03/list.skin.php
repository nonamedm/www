...
#product03 .listForm > li:hover {
    box-shadow:20px 20px 30px rgba(0,0,0,.1)
}
#product03 .listForm > li:hover a:after {
    content:""; 
    display:block; 
    position:absolute; 
    top:0; 
...
#product03 .listForm li .img_box {
    width:100%;
    height:220px;
    overflow: hidden;
    transition:0.6s;
}
#product03 .listForm li .text_box h2 {
    font-size:1.8em;
    font-weight:bold;
...
#product03 .listForm li .text_box p {
    font-size:1.2em;
    font-weight:300;
    font-family: 'Noto Sans KR', sans-serif;
    color:#333;
}
#product03 .listForm li:hover .text_box p{
    font-size:1.1em;
    transition:all 0.6s;
}
#product03 .listForm .infoBox {
    padding:0 20px 20px 20px;
}
#product03 .listForm .infoBox ul li {
    display:flex;
    width:100%;
    padding-bottom:5px;
}
#product03 .listForm .infoBox ul li:last-child {
    padding-bottom:0;
}
#product03 .listForm .infoBox ul li .tit {
    width:25%;
    font-size:16px;
    font-weight:bold;
    color:#333;
}
#product03 .listForm .infoBox ul li .txt {
    width:75%;
    font-size:16px;
    font-weight:400;
    color:#333;
...
@media screen and (max-width:960px) {
    ...
    #product03 .listForm > li:nth-child(2n) {
        margin-left:4%;
    }
}
@media screen and (max-width:800px) {
    ...
    #product03 .listForm > li:nth-child(3n) {
        margin:20px auto;
    }
}
/* e:#product03 */
