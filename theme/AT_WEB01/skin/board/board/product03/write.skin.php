...
<body>
    <div class="sub sub01" id="board_list01">
            ...
            <article class="inner">
                <section id="bo_w">
                    ...
                    <div class="infoBox">
                        <ul>
                            <li>
                                <label for="wr_1" class="sound_only">테마</label>
                                <input type="text" name="wr_1" value="" id="wr_1" class="frm_input" placeholder="테마를 입력하세요">
                            </li>
                            <li>
                                <label for="wr_2" class="sound_only">가격</label>
                                <input type="text" name="wr_2" value="" id="wr_2" class="frm_input" placeholder="가격을 입력하세요">
                            </li>
                            <li>
                                <label for="wr_3" class="sound_only">버전</label>
                                <input type="text" name="wr_3" value="" id="wr_3" class="frm_input" placeholder="버전을 입력하세요">
                            </li>
                            <li>
                                <label for="wr_4" class="sound_only">주요사업</label>
                                <input type="text" name="wr_4" value="" id="wr_4" class="frm_input" placeholder="주요사업을 입력하세요">
                            </li>
                        </ul>                        
                    </div>
