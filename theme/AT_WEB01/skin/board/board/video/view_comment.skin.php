...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
		...
		<div class="pt-2 pb-2">
            ...
            <label for="wr_secret"><i class="fa fa-lock" aria-hidden="true"></i><span class="">비밀글사용</span></label>
		</div>
        <div class="">
            <input type="submit" id="btn_submit" class="btn btn-info btn-block text14" value="댓글등록">
        </div>
    </div>
    </form>
</aside>
