...
<body>
    <div class="sub" id="board_gallery01">
            ...
            <div class="inner">
                ...
                <div>
                    <ul class="listForm">
                        ...
                        $movie_company = $list[$i]['wr_1'];
                        $movie_id = $list[$i]['wr_2'];
                        ...
                        <li>
                            ...
                            <a href="<?php echo $list[$i]['href'] ?>">
                                ...
                                <?php if(!$list[$i]['wr_3'] || $list[$i]['wr_3'] == "noimg"){?>
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo $board_skin_url?>/img/noimg.png" alt="<?php echo $list[$i]['subject'] ?>" >
                                    <?php } ?>
                                <?php } else { ?>
                                    <img src="<?php echo $list[$i]['wr_3'];?>" alt="<?php echo $list[$i]['subject'] ?>" style="width:100%;">
                                <?php } ?>
                                </div>
                                <div class="text_box">
                                    <h2><?php echo $list[$i]['subject'] ?> </h2>
                                    <p><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 30, '..'); ?></p>
                                </div>
                                <div class="text_hover">
                                    <h2><?php echo $list[$i]['subject'] ?> </h2>
                                    <p><?php echo utf8_strcut(strip_tags($list[$i]['wr_content']), 120, '..'); ?></p>
                                </div>
                            </a>
                        </li>
                        <?php } ?>
