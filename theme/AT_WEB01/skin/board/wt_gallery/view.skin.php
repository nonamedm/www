...
<article id="bo_v" style="background: #fff;">
   <div class="inner">
    ...
    <section id="bo_v_info" style="display: none;">
        <h2>페이지 정보</h2>
        <span class="sound_only">작성자</span><strong class="bo_v_writer"><?php echo $view['name'] ?></strong>
    ...
    color: #00489a;">
                <?php
                echo cut_str(get_text($view['wr_2']), 70); // 글제목 출력
                ?></span>
                <span style="white-space:pre-line;">
                <?php echo $view['wr_1']; // 분류 출력 끝 ?>
                </span>
            </div>
        </div>
    ...
    padding-top: 100px;"><?php echo get_view_thumbnail($view['content']); ?></div>
