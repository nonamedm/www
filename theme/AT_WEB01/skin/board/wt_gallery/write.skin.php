...
<article class="inner">
    <section id="bo_w">
        ...
        <div class="write_div">
            <label for="wr_2" class="sound_only">모델명<strong>필수</strong></label>
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required class="frm_input full_input required" size="50" maxlength="255" placeholder="모델명">
        </div>

        <div class="write_div">
            <label for="wr_1" class="sound_only">간략내용<strong>필수</strong></label>
            <textarea name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" class="frm_input full_input" rows="5" placeholder="상품 리스트에 보여질 간략 내용을 4줄 내외로 입력해주세요.
• ex)간략히 입력해주세요
• ex)간략히 입력해주세요.
• ex)간략히 입력해주세요.
• ex)간략히 입력해주세요.
"><?php echo $wr_1 ?></textarea>
        </div>
        ...
        function fwrite_submit(f)
        {
            ...
            if($('#wr_1')[0].value !==''){
                var wr_1_len = $('#wr_1')[0].value.split("\n").length;
                for(var i = 0; i<wr_1_len;i++){
                    if($('#wr_1')[0].value.split("\n")[i].length > 34){
                        alert('리스트에 들어갈'+(i+1)+'번 문구를 34자로 쓰셔야합니다.');
                        return false;
                    }
                }
            }else{
                alert("리스트에 들어갈 문구를 34자 이내로 입력해주세요.");
                return false;
            }
