    ...
    <div id="bo_list" class="faq_bo_list">
        ...
        <div id="bo_btn_top" class="faq_bo_btn_top wow fadeInUp">
            ...
            <ul class="btn_bo_user faq_btn_bo_user">
                ...
                <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn faq_btn btn_write"> 문의하기</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
        <!-- } 게시판 페이지 정보 및 버튼 끝 -->
        ...
        <form name="fboardlist" id="fboardlist" action="./board_list_update.php" onsubmit="return fboardlist_submit(this);" method="post" class="wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <?php if ($is_nogood) { ?><th scope="col"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 <i class="fa fa-sort" aria-hidden="true"></i></a></th><?php } ?> -->
                            <th scope="col" class="th_date"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?><a>작성일 </a></th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
