...
<button type="button" class="cmt_btn"><i class="fa fa-commenting-o" aria-hidden="true"></i> 답변목록</button>
<!-- 답변 시작 { -->
<section id="bo_vc">
    <h2>답변목록</h2>
    <?php
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        <header style="z-index:<?php echo $cmt_sv; ?>">
            <h2><?php echo get_text($list[$i]['wr_name']); ?>님의 <?php if ($cmt_depth) { ?><span class="sound_only">답변의</span><?php } ?> 답변</h2>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <textarea id="wr_content" name="wr_content" maxlength="10000" required class="required" title="내용" placeholder="답변내용을 입력해주세요" 
